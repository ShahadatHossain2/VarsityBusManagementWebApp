<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmergencyBusSchedule.aspx.cs" Inherits="VarsityBusManagementWebApp.UI.EmergencyBusSchedule" %>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
             <ul class="navbar-nav ml-lg-auto">
                    <li class="nav-item">
                        <a class="nav-link smoothScroll" href="StudentMenu.aspx"><i class="fa fa-fw fa-backward"></i> </a>
                    </li>
                </ul>

            <a class="navbar-brand" style="color: #ffa500">Emergency Bus Schedule</a>
    ...
    <asp:GridView ID="cityListGridView" runat="server" AutoGenerateColumns="False" CssClass="mydatagrid" PagerStyle-CssClass="pager" style="margin-top: 3px">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Pickup Point">
                   ...
                   <asp:TemplateField HeaderText="Time">
                    <ItemTemplate>
                    <asp:Label runat="server" Text='<% #Eval("Way") %>'>'></asp:Label>
                        </ItemTemplate>
                </asp:TemplateField>
            </Columns>
