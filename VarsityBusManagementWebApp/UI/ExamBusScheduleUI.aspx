<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExamBusScheduleUI.aspx.cs" Inherits="VarsityBusManagementWebApp.UI.ExamBusScheduleUI" %>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
           <%--  <ul class="navbar-nav ml-lg-auto">
                    <li class="nav-item">
                        <a href="o" class="nav-link smoothScroll"><i class="fa fa-fw fa-backward"></i> </a>
                    </li>
                </ul>--%>

            <a class="navbar-brand" style="color: #ffa500">Exam Bus Schedule</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-lg-auto">
                          <li class="nav-item">
                         <a href="ScheduleUI.aspx" class="nav-link smoothScroll"><i class="fa fa-fw fa-table"></i> Male Bus Schedule</a>
                    </li>
                    <li class="nav-item">
